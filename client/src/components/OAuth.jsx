...
export default function OAuth() {            
  ...
  return (
        <button type='button' title="Continue with Google" onClick={handleGoogleClick} className='main-btn normal-shadow text-black w-full max-lg:w-min p-2 select-none flex justify-center items-center bg-transparent text-nowrap transition-all duration-200 ease-in-out border-2 border-black border-solid max-lg:border-none rounded-full lg:rounded-md'>
