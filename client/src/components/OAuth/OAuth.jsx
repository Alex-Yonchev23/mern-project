...
export default function OAuth() {            
  ...
  return (
        <button type='button' title="Continue with Google" onClick={handleGoogleClick} className='normal-shadow text-black rounded-md w-full max-lg:w-min p-2 select-none flex justify-center items-center bg-transparent text-nowrap lg:p-8 transition-all duration-200 ease-in-out border-2 border-black border-solid max-lg:border-none max-lg:rounded-full'>
