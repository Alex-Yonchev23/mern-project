...
export default function DashUsers() {
    ...
    return (
        <div className='table-auto min-h-screen w-fit xl:w-11/12 m-2 xl:mx-auto overflow-x-auto scrollbar scrollbar-track-slate-100 scrollbar-thumb-yellow-400  px-8 pb-8 rounded-xl big-shadow border-2 border-yellow-400 border-solid bg-black/80 backdrop-blur-[1.5px] mt-3 mb-5'>
            <h1 className=' text-yellow-50 text-center mb-4 text-2xl bg-yellow-400 w-fit px-20 py-1 font-semibold rounded-b-lg'>Потребители</h1>
            {loading ? (
                <LoadingSpinner/>
            ) : (
                users.length > 0 ? (
                    <>        
                        ...
                        <Table hoverable className='bg-transparent'>
                            <Table.Head className='text-black text-md font-semibold tracking-wider text-nowrap'>
                                <Table.HeadCell className='bg-yellow-50'>Дата на създаване</Table.HeadCell>
                                <Table.HeadCell className='bg-yellow-50'>Аватар</Table.HeadCell>
                                <Table.HeadCell className='bg-yellow-50'>Първо име</Table.HeadCell>
                                <Table.HeadCell className='bg-yellow-50'>Фамилно име</Table.HeadCell>
                                <Table.HeadCell className='bg-yellow-50'>Имейл</Table.HeadCell>
                                <Table.HeadCell className='bg-yellow-50'>Админ</Table.HeadCell>
                    ...
                    {/*
                    <p className="text-yellow-50 raleway mt-2">Общо потребители: {totalUsers}</p>
                    <p className="text-yellow-50 raleway">Оставащи потребители: {remainingUsers}</p>
                    */}
                    ...
                    <p className='beige'>Все още нямате потребители!</p>
                )
            )}
